...
print("save output")
output_path = output_dir + '/' + image_id + "-" +str(rotation_degree) + '-crop' + crop +"-"+ 'attrMap.pkl'
...
bbox_mask_image = np.array(bbox_mask_image)
...
print("save output")
output_path = output_dir + '/' + image_id + "-" +str(rotation_degree) + '-crop' + crop +"-"+ 'image.pkl'
with open(output_path, "wb") as f:
    pickle.dump(image, f)
